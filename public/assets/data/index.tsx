...
export const CAROUSEL_ITEMS: HeroCarouselItemProps[] = [
	{
		...
		description: (
			<>
				Os nossos equipamentos purificam e transformam a água através de
				um processo de ionização natural com minerais
			</>
		),
	},
	{
	...
	},
	{
		...
		description: (
			<>
				A água é o nutriente mais abundante e importante do nosso corpo.{" "}
				<br />
	...
	},
	{
		...
		description: (
			<>
				Faça a sua própria água potável, alcalina e antioxidante, <br />{" "}
				rica em minerais e removida de impurezas, diretamente em sua
